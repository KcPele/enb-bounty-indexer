  ...
  contracts: {
    ENBBountyContract: {
      ...
      chain: isProduction ? {
        ...
        localhost: {
          ...
          address: (process.env.ENB_BOUNTY_ADDRESS || "0x322813Fd9A801c5507c9de605d63CEA4f2CE6c44") as `0x${string}`,
          startBlock: 0,
        },
      },
    },
    ENBBountyNFTContract: {
      ...
      chain: isProduction ? {
        ...
        localhost: {
          // From deployments/localhost.json
          address: (process.env.ENB_BOUNTY_NFT_ADDRESS || "0x4ed7c70F96B99c776995fB64377f0d4aB3B0e1C1") as `0x${string}`,
          startBlock: 0,
        },
      },
    },
